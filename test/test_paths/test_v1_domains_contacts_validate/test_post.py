...
from godaddy_python_sdk.paths.v1_domains_contacts_validate import post
from godaddy_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DomainsContactsValidate(ApiTestMixin, unittest.TestCase):
    """
    V1DomainsContactsValidate unit test stubs
