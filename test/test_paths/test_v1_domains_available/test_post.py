...
from godaddy_python_sdk.paths.v1_domains_available import post
from godaddy_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestV1DomainsAvailable(ApiTestMixin, unittest.TestCase):
    """
    V1DomainsAvailable unit test stubs
