...
from godaddy_python_sdk.model.domain_contacts import DomainContacts as DomainContactsSchema
...
from godaddy_python_sdk.type.domain_contacts import DomainContacts
...
from godaddy_python_sdk.pydantic.domain_contacts import DomainContacts as DomainContactsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainContactsSchema
SchemaForRequestBodyApplicationXml = DomainContactsSchema
SchemaForRequestBodyTextXml = DomainContactsSchema


request_body_domain_contacts = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_domain_contacts_mapped_args(
        self,
    ...
    async def _aupdate_domain_contacts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/domains/{domain}/contacts',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_domain_contacts.serialize(body, content_type)
    ...
    def _update_domain_contacts_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateDomainContactsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_domain_contacts(
        self,
        contact_registrant: Contact,
        domain: str,
        contact_admin: typing.Optional[Contact] = None,
        ...
        **kwargs,
        ...
        args = self._update_domain_contacts_mapped_args(
            body=body,
        ...
        return await self._aupdate_domain_contacts_oapg(
            body=args.body,
    ...
    def update_domain_contacts(
        ...
        return self._update_domain_contacts_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateDomainContacts(BaseApi):
    ...
    async def aupdate_domain_contacts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_domain_contacts(
            body=body,
            contact_registrant=contact_registrant,
            domain=domain,
            contact_admin=contact_admin,
    ...
    def update_domain_contacts(
        ...
        raw_response = self.raw.update_domain_contacts(
            body=body,
            contact_registrant=contact_registrant,
            domain=domain,
            contact_admin=contact_admin,
