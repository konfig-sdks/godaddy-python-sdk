...
from godaddy_python_sdk.model.v1_get_tlds_list200_response2 import V1GetTldsList200Response2 as V1GetTldsList200Response2Schema
from godaddy_python_sdk.model.v1_get_tlds_list200_response1 import V1GetTldsList200Response1 as V1GetTldsList200Response1Schema
from godaddy_python_sdk.model.v1_get_tlds_list200_response import V1GetTldsList200Response as V1GetTldsList200ResponseSchema
from godaddy_python_sdk.model.v1_get_tlds_list200_response3 import V1GetTldsList200Response3 as V1GetTldsList200Response3Schema
from godaddy_python_sdk.model.v1_get_tlds_list_response import V1GetTldsListResponse as V1GetTldsListResponseSchema
...
from godaddy_python_sdk.type.v1_get_tlds_list200_response import V1GetTldsList200Response
from godaddy_python_sdk.type.error_limit import ErrorLimit
from godaddy_python_sdk.type.v1_get_tlds_list200_response2 import V1GetTldsList200Response2
from godaddy_python_sdk.type.v1_get_tlds_list_response import V1GetTldsListResponse
from godaddy_python_sdk.type.v1_get_tlds_list200_response1 import V1GetTldsList200Response1
from godaddy_python_sdk.type.v1_get_tlds_list200_response3 import V1GetTldsList200Response3

from ...api_client import Dictionary
from godaddy_python_sdk.pydantic.v1_get_tlds_list_response import V1GetTldsListResponse as V1GetTldsListResponsePydantic
...
from godaddy_python_sdk.pydantic.v1_get_tlds_list200_response1 import V1GetTldsList200Response1 as V1GetTldsList200Response1Pydantic
from godaddy_python_sdk.pydantic.v1_get_tlds_list200_response import V1GetTldsList200Response as V1GetTldsList200ResponsePydantic
from godaddy_python_sdk.pydantic.v1_get_tlds_list200_response2 import V1GetTldsList200Response2 as V1GetTldsList200Response2Pydantic
from godaddy_python_sdk.pydantic.v1_get_tlds_list200_response3 import V1GetTldsList200Response3 as V1GetTldsList200Response3Pydantic

SchemaFor200ResponseBodyApplicationJson = V1GetTldsList200ResponseSchema
SchemaFor200ResponseBodyApplicationJavascript = V1GetTldsListResponseSchema
SchemaFor200ResponseBodyApplicationXml = V1GetTldsList200Response1Schema
SchemaFor200ResponseBodyTextJavascript = V1GetTldsList200Response2Schema
SchemaFor200ResponseBodyTextXml = V1GetTldsList200Response3Schema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: V1GetTldsList200Response
...
class BaseApi(api_client.Api):
    ...
    def _get_tlds_list_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_tlds_list_oapg(
        self,
...
class GetTldsListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tlds_list(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_tlds_list_mapped_args(
        )
        return await self._aget_tlds_list_oapg(
            **kwargs,
        )
    ...
    def get_tlds_list(
        ...
        return self._get_tlds_list_oapg(
        )

class GetTldsList(BaseApi):

    async def aget_tlds_list(
        self,
        validate: bool = False,
        **kwargs,
    ) -> V1GetTldsList200ResponsePydantic:
        raw_response = await self.raw.aget_tlds_list(
            **kwargs,
        )
        if validate:
            return RootModel[V1GetTldsList200ResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(V1GetTldsList200ResponsePydantic, raw_response.body)
    ...
    def get_tlds_list(
        ...
        raw_response = self.raw.get_tlds_list(
        )
        if validate:
            return RootModel[V1GetTldsList200ResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(V1GetTldsList200ResponsePydantic, raw_response.body)
