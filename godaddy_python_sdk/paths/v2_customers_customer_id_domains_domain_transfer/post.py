...
from godaddy_python_sdk.model.domain_transfer_in_v2 import DomainTransferInV2 as DomainTransferInV2Schema
from godaddy_python_sdk.model.error_limit import ErrorLimit as ErrorLimitSchema

from godaddy_python_sdk.type.domain_transfer_in_v2 import DomainTransferInV2
...
from godaddy_python_sdk.pydantic.domain_transfer_in_v2 import DomainTransferInV2 as DomainTransferInV2Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainTransferInV2Schema


request_body_domain_transfer_in_v2 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _purchase_transfer_process_mapped_args(
        self,
        auth_code: str,
        consent: ConsentV2,
        customer_id: str,
        ...
        identity_document_id: typing.Optional[str] = None,
        ...
        if auth_code is not None:
            _body["authCode"] = auth_code
        if consent is not None:
            _body["consent"] = consent
        if contacts is not None:
            _body["contacts"] = contacts
        if identity_document_id is not None:
            _body["identityDocumentId"] = identity_document_id
    ...
    async def _apurchase_transfer_process_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/transfer',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_domain_transfer_in_v2.serialize(body, content_type)
    ...
    def _purchase_transfer_process_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class PurchaseTransferProcessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apurchase_transfer_process(
        self,
        auth_code: str,
        consent: ConsentV2,
        customer_id: str,
        ...
        **kwargs,
        ...
        args = self._purchase_transfer_process_mapped_args(
            auth_code=auth_code,
            consent=consent,
        ...
        return await self._apurchase_transfer_process_oapg(
            body=args.body,
    ...
    def purchase_transfer_process(
        ...
        return self._purchase_transfer_process_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PurchaseTransferProcess(BaseApi):
    ...
    async def apurchase_transfer_process(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apurchase_transfer_process(
            auth_code=auth_code,
            consent=consent,
            customer_id=customer_id,
            domain=domain,
    ...
    def purchase_transfer_process(
        ...
        raw_response = self.raw.purchase_transfer_process(
            auth_code=auth_code,
            consent=consent,
            customer_id=customer_id,
            domain=domain,
