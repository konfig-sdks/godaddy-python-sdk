...
from godaddy_python_sdk.model.maintenance import Maintenance as MaintenanceSchema
...
from godaddy_python_sdk.type.maintenance import Maintenance
...
from godaddy_python_sdk.pydantic.maintenance import Maintenance as MaintenancePydantic
...
ModifiedAtAfterSchema = schemas.StrSchema
StartsAtAfterSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'modifiedAtAfter': typing.Union[ModifiedAtAfterSchema, str, ],
        'startsAtAfter': typing.Union[StartsAtAfterSchema, str, ],
...
request_query_starts_at_after = api_client.QueryParameter(
    name="startsAtAfter",
    style=api_client.ParameterStyle.FORM,
    schema=StartsAtAfterSchema,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = MaintenanceSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_upcoming_maintenances_list_mapped_args(
        self,
        x_request_id: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        modified_at_after: typing.Optional[str] = None,
        starts_at_after: typing.Optional[str] = None,
        ...
        if modified_at_after is not None:
            _query_params["modifiedAtAfter"] = modified_at_after
        if starts_at_after is not None:
            _query_params["startsAtAfter"] = starts_at_after
    ...
    async def _aget_upcoming_maintenances_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/domains/maintenances',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_upcoming_maintenances_list_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetUpcomingMaintenancesListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_upcoming_maintenances_list(
        self,
        x_request_id: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        modified_at_after: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._get_upcoming_maintenances_list_mapped_args(
        ...
        return await self._aget_upcoming_maintenances_list_oapg(
            query_params=args.query,
            header_params=args.header,
            **kwargs,
        )
    
    def get_upcoming_maintenances_list(
        self,
        x_request_id: typing.Optional[str] = None,
        status: typing.Optional[str] = None,
        modified_at_after: typing.Optional[str] = None,
        ...
        return self._get_upcoming_maintenances_list_oapg(
            query_params=args.query,
            header_params=args.header,
        )

class GetUpcomingMaintenancesList(BaseApi):
    ...
    async def aget_upcoming_maintenances_list(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_upcoming_maintenances_list(
            x_request_id=x_request_id,
            status=status,
            modified_at_after=modified_at_after,
            starts_at_after=starts_at_after,
        ...
        if validate:
            return MaintenancePydantic(**raw_response.body)
        return api_client.construct_model_instance(MaintenancePydantic, raw_response.body)
    ...
    def get_upcoming_maintenances_list(
        ...
        raw_response = self.raw.get_upcoming_maintenances_list(
            x_request_id=x_request_id,
            status=status,
            modified_at_after=modified_at_after,
            starts_at_after=starts_at_after,
