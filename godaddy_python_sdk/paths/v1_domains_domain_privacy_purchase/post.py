...
from godaddy_python_sdk.model.privacy_purchase import PrivacyPurchase as PrivacyPurchaseSchema
...
from godaddy_python_sdk.type.privacy_purchase import PrivacyPurchase
...
from godaddy_python_sdk.pydantic.privacy_purchase import PrivacyPurchase as PrivacyPurchasePydantic
...
# body param
SchemaForRequestBodyApplicationJson = PrivacyPurchaseSchema
SchemaForRequestBodyApplicationXml = PrivacyPurchaseSchema
SchemaForRequestBodyTextXml = PrivacyPurchaseSchema


request_body_privacy_purchase = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _purchase_privacy_for_domain_mapped_args(
        self,
        consent: Consent,
        domain: str,
    ...
    async def _apurchase_privacy_for_domain_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/domains/{domain}/privacy/purchase',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_privacy_purchase.serialize(body, content_type)
    ...
    def _purchase_privacy_for_domain_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class PurchasePrivacyForDomainRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def apurchase_privacy_for_domain(
        self,
        consent: Consent,
        domain: str,
        x_shopper_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._purchase_privacy_for_domain_mapped_args(
            body=body,
            consent=consent,
            domain=domain,
            x_shopper_id=x_shopper_id,
        )
        return await self._apurchase_privacy_for_domain_oapg(
            body=args.body,
    ...
    def purchase_privacy_for_domain(
        self,
        consent: Consent,
        domain: str,
        x_shopper_id: typing.Optional[str] = None,
        ...
        return self._purchase_privacy_for_domain_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class PurchasePrivacyForDomain(BaseApi):
    ...
    async def apurchase_privacy_for_domain(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.apurchase_privacy_for_domain(
            body=body,
            consent=consent,
            domain=domain,
            x_shopper_id=x_shopper_id,
    ...
    def purchase_privacy_for_domain(
        ...
        raw_response = self.raw.purchase_privacy_for_domain(
            body=body,
            consent=consent,
            domain=domain,
            x_shopper_id=x_shopper_id,
