...
# Query params
RegistrarSchema = schemas.StrSchema
RequestRequiredQueryParams = typing_extensions.TypedDict(
    'RequestRequiredQueryParams',
    {
        'registrar': typing.Union[RegistrarSchema, str, ],
    }
)
...
request_query_registrar = api_client.QueryParameter(
    name="registrar",
...
class BaseApi(api_client.Api):
    ...
    def _initiate_transfer_out_mapped_args(
        self,
        customer_id: str,
        domain: str,
        registrar: str,
        ...
        if registrar is not None:
            _query_params["registrar"] = registrar
    ...
    async def _ainitiate_transfer_out_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/transferOut',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _initiate_transfer_out_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class InitiateTransferOutRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def ainitiate_transfer_out(
        self,
        customer_id: str,
        domain: str,
        registrar: str,
        ...
        **kwargs,
        ...
        args = self._initiate_transfer_out_mapped_args(
            customer_id=customer_id,
            domain=domain,
            registrar=registrar,
            x_request_id=x_request_id,
        )
        return await self._ainitiate_transfer_out_oapg(
    ...
    def initiate_transfer_out(
        ...
        return self._initiate_transfer_out_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class InitiateTransferOut(BaseApi):
    ...
    async def ainitiate_transfer_out(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.ainitiate_transfer_out(
            customer_id=customer_id,
            domain=domain,
            registrar=registrar,
            x_request_id=x_request_id,
    ...
    def initiate_transfer_out(
        ...
        raw_response = self.raw.initiate_transfer_out(
            customer_id=customer_id,
            domain=domain,
            registrar=registrar,
            x_request_id=x_request_id,
