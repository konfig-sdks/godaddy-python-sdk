...
from godaddy_python_sdk.model.actions_get_recent_list_response import ActionsGetRecentListResponse as ActionsGetRecentListResponseSchema

from godaddy_python_sdk.type.error import Error
from godaddy_python_sdk.type.error_limit import ErrorLimit
from godaddy_python_sdk.type.actions_get_recent_list_response import ActionsGetRecentListResponse
...
from godaddy_python_sdk.pydantic.actions_get_recent_list_response import ActionsGetRecentListResponse as ActionsGetRecentListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = ActionsGetRecentListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ActionsGetRecentListResponse
...
class BaseApi(api_client.Api):
    ...
    def _get_recent_list_mapped_args(
        self,
        customer_id: str,
        domain: str,
    ...
    async def _aget_recent_list_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/actions',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetRecentListRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_recent_list(
        self,
        customer_id: str,
        domain: str,
        x_request_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_recent_list_mapped_args(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
        return await self._aget_recent_list_oapg(
    ...
    def get_recent_list(
        ...
        return self._get_recent_list_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetRecentList(BaseApi):
    ...
    async def aget_recent_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ActionsGetRecentListResponsePydantic:
        raw_response = await self.raw.aget_recent_list(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
            **kwargs,
        ...
        if validate:
            return RootModel[ActionsGetRecentListResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(ActionsGetRecentListResponsePydantic, raw_response.body)
    ...
    def get_recent_list(
        ...
        raw_response = self.raw.get_recent_list(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
