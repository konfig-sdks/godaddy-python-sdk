...
class BaseApi(api_client.Api):
    ...
    def _accept_transfer_in_mapped_args(
        self,
        auth_code: str,
        customer_id: str,
        domain: str,
    ...
    async def _aaccept_transfer_in_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/transferInAccept',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
...
class AcceptTransferInRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccept_transfer_in(
        self,
        auth_code: str,
        customer_id: str,
        domain: str,
        ...
        **kwargs,
        ...
        args = self._accept_transfer_in_mapped_args(
            auth_code=auth_code,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
        return await self._aaccept_transfer_in_oapg(
            body=args.body,
    ...
    def accept_transfer_in(
        ...
        return self._accept_transfer_in_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class AcceptTransferIn(BaseApi):
    ...
    async def aaccept_transfer_in(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aaccept_transfer_in(
            auth_code=auth_code,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
    ...
    def accept_transfer_in(
        ...
        raw_response = self.raw.accept_transfer_in(
            auth_code=auth_code,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
