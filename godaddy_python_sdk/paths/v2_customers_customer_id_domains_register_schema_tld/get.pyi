...
class BaseApi(api_client.Api):
    ...
    def _get_register_schema_mapped_args(
        self,
        customer_id: str,
        tld: str,
    ...
    async def _aget_register_schema_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/register/schema/{tld}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetRegisterSchemaRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_register_schema(
        self,
        customer_id: str,
        tld: str,
        x_request_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_register_schema_mapped_args(
            customer_id=customer_id,
            tld=tld,
            x_request_id=x_request_id,
        )
        return await self._aget_register_schema_oapg(
    ...
    def get_register_schema(
        ...
        return self._get_register_schema_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetRegisterSchema(BaseApi):
    ...
    async def aget_register_schema(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_register_schema(
            customer_id=customer_id,
            tld=tld,
            x_request_id=x_request_id,
            **kwargs,
    ...
    def get_register_schema(
        ...
        raw_response = self.raw.get_register_schema(
            customer_id=customer_id,
            tld=tld,
            x_request_id=x_request_id,
        )
