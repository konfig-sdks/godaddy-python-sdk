...
from godaddy_python_sdk.model.action import Action as ActionSchema
...
from godaddy_python_sdk.pydantic.action import Action as ActionPydantic
...
class BaseApi(api_client.Api):
    ...
    def _get_recent_action_mapped_args(
        self,
        customer_id: str,
        domain: str,
        type: str,
    ...
    async def _aget_recent_action_oapg(
        self,
...
class GetRecentActionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_recent_action(
        self,
        customer_id: str,
        domain: str,
        type: str,
        ...
        **kwargs,
        ...
        args = self._get_recent_action_mapped_args(
            customer_id=customer_id,
            domain=domain,
            type=type,
            x_request_id=x_request_id,
        )
        return await self._aget_recent_action_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def get_recent_action(
        self,
        customer_id: str,
        domain: str,
        type: str,
        ...
        return self._get_recent_action_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetRecentAction(BaseApi):
    ...
    async def aget_recent_action(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_recent_action(
            customer_id=customer_id,
            domain=domain,
            type=type,
            x_request_id=x_request_id,
    ...
    def get_recent_action(
        ...
        raw_response = self.raw.get_recent_action(
            customer_id=customer_id,
            domain=domain,
            type=type,
            x_request_id=x_request_id,
