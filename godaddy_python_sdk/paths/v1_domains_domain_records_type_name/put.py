...
from godaddy_python_sdk.model.v1_replace_dns_records_type_request4 import V1ReplaceDnsRecordsTypeRequest4 as V1ReplaceDnsRecordsTypeRequest4Schema
from godaddy_python_sdk.model.v1_replace_dns_records_type_request5 import V1ReplaceDnsRecordsTypeRequest5 as V1ReplaceDnsRecordsTypeRequest5Schema
from godaddy_python_sdk.model.error import Error as ErrorSchema
from godaddy_python_sdk.model.v1_replace_dns_records_type_request3 import V1ReplaceDnsRecordsTypeRequest3 as V1ReplaceDnsRecordsTypeRequest3Schema
from godaddy_python_sdk.model.error_limit import ErrorLimit as ErrorLimitSchema

from godaddy_python_sdk.type.v1_replace_dns_records_type_request4 import V1ReplaceDnsRecordsTypeRequest4
from godaddy_python_sdk.type.v1_replace_dns_records_type_request3 import V1ReplaceDnsRecordsTypeRequest3
from godaddy_python_sdk.type.error import Error
from godaddy_python_sdk.type.error_limit import ErrorLimit
from godaddy_python_sdk.type.v1_replace_dns_records_type_request5 import V1ReplaceDnsRecordsTypeRequest5
...
from godaddy_python_sdk.pydantic.v1_replace_dns_records_type_request3 import V1ReplaceDnsRecordsTypeRequest3 as V1ReplaceDnsRecordsTypeRequest3Pydantic
from godaddy_python_sdk.pydantic.v1_replace_dns_records_type_request4 import V1ReplaceDnsRecordsTypeRequest4 as V1ReplaceDnsRecordsTypeRequest4Pydantic
from godaddy_python_sdk.pydantic.v1_replace_dns_records_type_request5 import V1ReplaceDnsRecordsTypeRequest5 as V1ReplaceDnsRecordsTypeRequest5Pydantic
...
# body param
SchemaForRequestBodyApplicationJson = V1ReplaceDnsRecordsTypeRequest3Schema
SchemaForRequestBodyApplicationXml = V1ReplaceDnsRecordsTypeRequest4Schema
SchemaForRequestBodyTextXml = V1ReplaceDnsRecordsTypeRequest5Schema


request_body_v1_replace_dns_records_type_request3 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _replace_dns_records_type_0_mapped_args(
        self,
        body: V1ReplaceDnsRecordsTypeRequest3,
        domain: str,
        type: str,
        name: str,
    ...
    async def _areplace_dns_records_type_0_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_v1_replace_dns_records_type_request3.serialize(body, content_type)
    ...
    def _replace_dns_records_type_0_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class ReplaceDnsRecordsType0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplace_dns_records_type_0(
        self,
        body: V1ReplaceDnsRecordsTypeRequest3,
        domain: str,
        type: str,
        ...
        **kwargs,
        ...
        args = self._replace_dns_records_type_0_mapped_args(
            body=body,
            domain=domain,
            type=type,
            name=name,
        ...
        return await self._areplace_dns_records_type_0_oapg(
            body=args.body,
    ...
    def replace_dns_records_type_0(
        self,
        body: V1ReplaceDnsRecordsTypeRequest3,
        domain: str,
        type: str,
        ...
        return self._replace_dns_records_type_0_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ReplaceDnsRecordsType0(BaseApi):
    ...
    async def areplace_dns_records_type_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areplace_dns_records_type_0(
            body=body,
            domain=domain,
            type=type,
            name=name,
    ...
    def replace_dns_records_type_0(
        ...
        raw_response = self.raw.replace_dns_records_type_0(
            body=body,
            domain=domain,
            type=type,
            name=name,
