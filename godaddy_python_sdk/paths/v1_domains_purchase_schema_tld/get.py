...
from godaddy_python_sdk.model.json_schema import JsonSchema as JsonSchemaSchema
...
from godaddy_python_sdk.type.json_schema import JsonSchema

from ...api_client import Dictionary
from godaddy_python_sdk.pydantic.json_schema import JsonSchema as JsonSchemaPydantic
...
# Path params
TldSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'tld': typing.Union[TldSchema, str, ],
    }
)
...
request_path_tld = api_client.PathParameter(
    name="tld",
...
SchemaFor200ResponseBodyApplicationJson = JsonSchemaSchema
SchemaFor200ResponseBodyApplicationJavascript = JsonSchemaSchema
SchemaFor200ResponseBodyApplicationXml = JsonSchemaSchema
SchemaFor200ResponseBodyTextJavascript = JsonSchemaSchema
SchemaFor200ResponseBodyTextXml = JsonSchemaSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_domain_schema_mapped_args(
        self,
        tld: str,
    ...
    async def _aget_domain_schema_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/domains/purchase/schema/{tld}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDomainSchemaRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_domain_schema(
        self,
        tld: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_domain_schema_mapped_args(
            tld=tld,
        )
        return await self._aget_domain_schema_oapg(
    ...
    def get_domain_schema(
        ...
        return self._get_domain_schema_oapg(
            path_params=args.path,
        )

class GetDomainSchema(BaseApi):
    ...
    async def aget_domain_schema(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_domain_schema(
            tld=tld,
            **kwargs,
        )
        if validate:
            return JsonSchemaPydantic(**raw_response.body)
        return api_client.construct_model_instance(JsonSchemaPydantic, raw_response.body)
    ...
    def get_domain_schema(
        ...
        raw_response = self.raw.get_domain_schema(
            tld=tld,
        )
        if validate:
            return JsonSchemaPydantic(**raw_response.body)
