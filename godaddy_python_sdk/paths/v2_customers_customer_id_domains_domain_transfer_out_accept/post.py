...
class BaseApi(api_client.Api):
    ...
    def _accept_transfer_out_mapped_args(
        self,
        customer_id: str,
        domain: str,
    ...
    async def _aaccept_transfer_out_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/transferOutAccept',
            auth_settings=_auth,
            headers=_headers,
        )
...
class AcceptTransferOutRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aaccept_transfer_out(
        self,
        customer_id: str,
        domain: str,
        x_request_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._accept_transfer_out_mapped_args(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
        return await self._aaccept_transfer_out_oapg(
    ...
    def accept_transfer_out(
        ...
        return self._accept_transfer_out_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class AcceptTransferOut(BaseApi):
    ...
    async def aaccept_transfer_out(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aaccept_transfer_out(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
            **kwargs,
    ...
    def accept_transfer_out(
        ...
        raw_response = self.raw.accept_transfer_out(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
