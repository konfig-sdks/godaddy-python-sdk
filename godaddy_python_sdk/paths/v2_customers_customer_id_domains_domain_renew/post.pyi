...
from godaddy_python_sdk.model.consent_renew import ConsentRenew as ConsentRenewSchema
from godaddy_python_sdk.model.domain_renew_v2 import DomainRenewV2 as DomainRenewV2Schema
from godaddy_python_sdk.model.error_limit import ErrorLimit as ErrorLimitSchema

from godaddy_python_sdk.type.domain_renew_v2 import DomainRenewV2
...
from godaddy_python_sdk.pydantic.domain_renew_v2 import DomainRenewV2 as DomainRenewV2Pydantic
from godaddy_python_sdk.pydantic.consent_renew import ConsentRenew as ConsentRenewPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainRenewV2Schema


request_body_domain_renew_v2 = api_client.RequestBody(
    content={
    ...
    async def _arenew_domain_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/renew',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_domain_renew_v2.serialize(body, content_type)
...
class RenewDomainRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arenew_domain(
        self,
        consent: ConsentRenew,
        expires: str,
        customer_id: str,
        ...
        **kwargs,
        ...
        args = self._renew_domain_mapped_args(
            consent=consent,
            expires=expires,
        ...
        return await self._arenew_domain_oapg(
            body=args.body,
    ...
    def renew_domain(
        ...
        return self._renew_domain_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class RenewDomain(BaseApi):
    ...
    async def arenew_domain(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arenew_domain(
            consent=consent,
            expires=expires,
            customer_id=customer_id,
            domain=domain,
    ...
    def renew_domain(
        ...
        raw_response = self.raw.renew_domain(
            consent=consent,
            expires=expires,
            customer_id=customer_id,
            domain=domain,
