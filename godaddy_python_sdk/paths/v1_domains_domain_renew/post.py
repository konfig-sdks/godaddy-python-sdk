...
from godaddy_python_sdk.model.domain_renew import DomainRenew as DomainRenewSchema
...
from godaddy_python_sdk.type.domain_renew import DomainRenew
...
from godaddy_python_sdk.pydantic.domain_renew import DomainRenew as DomainRenewPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainRenewSchema
SchemaForRequestBodyApplicationXml = DomainRenewSchema
SchemaForRequestBodyTextXml = DomainRenewSchema


request_body_domain_renew = api_client.RequestBody(
    content={
    ...
    async def _arenew_domain_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/domains/{domain}/renew',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_domain_renew.serialize(body, content_type)
