...
from godaddy_python_sdk.model.consent_redemption import ConsentRedemption as ConsentRedemptionSchema
from godaddy_python_sdk.model.error import Error as ErrorSchema
from godaddy_python_sdk.model.domain_redeem_v2 import DomainRedeemV2 as DomainRedeemV2Schema
...
from godaddy_python_sdk.type.domain_redeem_v2 import DomainRedeemV2
...
from godaddy_python_sdk.pydantic.domain_redeem_v2 import DomainRedeemV2 as DomainRedeemV2Pydantic
from godaddy_python_sdk.pydantic.consent_redemption import ConsentRedemption as ConsentRedemptionPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainRedeemV2Schema


request_body_domain_redeem_v2 = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _redeem_domain_restore_mapped_args(
        self,
    ...
    async def _aredeem_domain_restore_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/redeem',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_domain_redeem_v2.serialize(body, content_type)
    ...
    def _redeem_domain_restore_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RedeemDomainRestoreRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aredeem_domain_restore(
        self,
        consent: ConsentRedemption,
        customer_id: str,
        domain: str,
        ...
        **kwargs,
        ...
        args = self._redeem_domain_restore_mapped_args(
            consent=consent,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
        return await self._aredeem_domain_restore_oapg(
            body=args.body,
    ...
    def redeem_domain_restore(
        ...
        return self._redeem_domain_restore_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class RedeemDomainRestore(BaseApi):
    ...
    async def aredeem_domain_restore(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aredeem_domain_restore(
            consent=consent,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
    ...
    def redeem_domain_restore(
        ...
        raw_response = self.raw.redeem_domain_restore(
            consent=consent,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
