...
from godaddy_python_sdk.model.domain_notification import DomainNotification as DomainNotificationSchema
from godaddy_python_sdk.model.error_limit import ErrorLimit as ErrorLimitSchema

from godaddy_python_sdk.type.domain_notification import DomainNotification
from godaddy_python_sdk.type.error import Error
from godaddy_python_sdk.type.error_limit import ErrorLimit

from ...api_client import Dictionary
from godaddy_python_sdk.pydantic.domain_notification import DomainNotification as DomainNotificationPydantic
...
SchemaFor200ResponseBodyApplicationJson = DomainNotificationSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DomainNotification
...
class BaseApi(api_client.Api):
    ...
    def _get_next_domain_mapped_args(
        self,
        customer_id: str,
    ...
    async def _aget_next_domain_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/notifications',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetNextDomainRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_next_domain(
        self,
        customer_id: str,
        x_request_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_next_domain_mapped_args(
            customer_id=customer_id,
            x_request_id=x_request_id,
        )
        return await self._aget_next_domain_oapg(
    ...
    def get_next_domain(
        ...
        return self._get_next_domain_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetNextDomain(BaseApi):
    ...
    async def aget_next_domain(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DomainNotificationPydantic:
        raw_response = await self.raw.aget_next_domain(
            customer_id=customer_id,
            x_request_id=x_request_id,
            **kwargs,
        )
        if validate:
            return DomainNotificationPydantic(**raw_response.body)
        return api_client.construct_model_instance(DomainNotificationPydantic, raw_response.body)
    ...
    def get_next_domain(
        ...
        raw_response = self.raw.get_next_domain(
            customer_id=customer_id,
            x_request_id=x_request_id,
        )
        if validate:
