...
from godaddy_python_sdk.model.domain_detail_v2 import DomainDetailV2 as DomainDetailV2Schema
...
from godaddy_python_sdk.type.domain_detail_v2 import DomainDetailV2
...
from godaddy_python_sdk.pydantic.domain_detail_v2 import DomainDetailV2 as DomainDetailV2Pydantic
        ...
        class items(
            ...
            class MetaOapg:
                enum_value_to_name = {
                    "actions": "ACTIONS",
                    "contacts": "CONTACTS",
                    "dnssecRecords": "DNSSEC_RECORDS",
                    "registryStatusCodes": "REGISTRY_STATUS_CODES",
                }
            ...
            @schemas.classproperty
            def DNSSEC_RECORDS(cls):
                return cls("dnssecRecords")
            
            @schemas.classproperty
            def REGISTRY_STATUS_CODES(cls):
                return cls("registryStatusCodes")
...
SchemaFor200ResponseBodyApplicationJson = DomainDetailV2Schema
...
SchemaFor203ResponseBodyApplicationJson = DomainDetailV2Schema
    ...
    async def _aget_details_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDetails(BaseApi):
    ...
    async def aget_details(
        ...
        **kwargs,
        ...
        if validate:
            return DomainDetailV2Pydantic(**raw_response.body)
        return api_client.construct_model_instance(DomainDetailV2Pydantic, raw_response.body)
