...
from godaddy_python_sdk.model.domain_transfer_in import DomainTransferIn as DomainTransferInSchema
...
from godaddy_python_sdk.type.domain_transfer_in import DomainTransferIn
...
from godaddy_python_sdk.pydantic.domain_transfer_in import DomainTransferIn as DomainTransferInPydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainTransferInSchema
SchemaForRequestBodyApplicationXml = DomainTransferInSchema
SchemaForRequestBodyTextXml = DomainTransferInSchema


request_body_domain_transfer_in = api_client.RequestBody(
    content={
    ...
    async def _apurchase_transfer_process_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/domains/{domain}/transfer',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_domain_transfer_in.serialize(body, content_type)
