...
class BaseApi(api_client.Api):
    ...
    def _validate_domain_registration_mapped_args(
        self,
        consent: ConsentV2,
        domain: str,
        customer_id: str,
    ...
    async def _avalidate_domain_registration_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/register/validate',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _validate_domain_registration_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class ValidateDomainRegistrationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def avalidate_domain_registration(
        self,
        consent: ConsentV2,
        domain: str,
        customer_id: str,
        ...
        **kwargs,
        ...
        args = self._validate_domain_registration_mapped_args(
            consent=consent,
            domain=domain,
        ...
        return await self._avalidate_domain_registration_oapg(
            body=args.body,
    ...
    def validate_domain_registration(
        ...
        return self._validate_domain_registration_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ValidateDomainRegistration(BaseApi):
    ...
    async def avalidate_domain_registration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avalidate_domain_registration(
            consent=consent,
            domain=domain,
            customer_id=customer_id,
            contacts=contacts,
    ...
    def validate_domain_registration(
        ...
        raw_response = self.raw.validate_domain_registration(
            consent=consent,
            domain=domain,
            customer_id=customer_id,
            contacts=contacts,
