...
from godaddy_python_sdk.model.domain_transfer_auth_code import DomainTransferAuthCode as DomainTransferAuthCodeSchema
...
from godaddy_python_sdk.type.domain_transfer_auth_code import DomainTransferAuthCode
...
from godaddy_python_sdk.pydantic.domain_transfer_auth_code import DomainTransferAuthCode as DomainTransferAuthCodePydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainTransferAuthCodeSchema


request_body_domain_transfer_auth_code = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _retry_transfer_in_process_mapped_args(
        self,
        auth_code: str,
        customer_id: str,
        domain: str,
    ...
    async def _aretry_transfer_in_process_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/transferInRetry',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_domain_transfer_auth_code.serialize(body, content_type)
    ...
    def _retry_transfer_in_process_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class RetryTransferInProcessRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aretry_transfer_in_process(
        self,
        auth_code: str,
        customer_id: str,
        domain: str,
        ...
        **kwargs,
        ...
        args = self._retry_transfer_in_process_mapped_args(
            auth_code=auth_code,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
        return await self._aretry_transfer_in_process_oapg(
            body=args.body,
    ...
    def retry_transfer_in_process(
        ...
        return self._retry_transfer_in_process_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class RetryTransferInProcess(BaseApi):
    ...
    async def aretry_transfer_in_process(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aretry_transfer_in_process(
            auth_code=auth_code,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
    ...
    def retry_transfer_in_process(
        ...
        raw_response = self.raw.retry_transfer_in_process(
            auth_code=auth_code,
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
