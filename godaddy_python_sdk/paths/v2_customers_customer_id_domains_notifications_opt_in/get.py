...
from godaddy_python_sdk.model.notifications_list_opted_in_types_response import NotificationsListOptedInTypesResponse as NotificationsListOptedInTypesResponseSchema
...
from godaddy_python_sdk.type.notifications_list_opted_in_types_response import NotificationsListOptedInTypesResponse
...
from godaddy_python_sdk.pydantic.notifications_list_opted_in_types_response import NotificationsListOptedInTypesResponse as NotificationsListOptedInTypesResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = NotificationsListOptedInTypesResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: NotificationsListOptedInTypesResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_opted_in_types_mapped_args(
        self,
        customer_id: str,
    ...
    async def _alist_opted_in_types_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/notifications/optIn',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListOptedInTypesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_opted_in_types(
        self,
        customer_id: str,
        x_request_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._list_opted_in_types_mapped_args(
            customer_id=customer_id,
            x_request_id=x_request_id,
        )
        return await self._alist_opted_in_types_oapg(
            header_params=args.header,
            path_params=args.path,
            **kwargs,
        )
    
    def list_opted_in_types(
        self,
        customer_id: str,
        x_request_id: typing.Optional[str] = None,
    ) -> typing.Union[
        ...
        return self._list_opted_in_types_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ListOptedInTypes(BaseApi):
    ...
    async def alist_opted_in_types(
        ...
        validate: bool = False,
        **kwargs,
    ) -> NotificationsListOptedInTypesResponsePydantic:
        raw_response = await self.raw.alist_opted_in_types(
            customer_id=customer_id,
            x_request_id=x_request_id,
            **kwargs,
        )
        if validate:
            return RootModel[NotificationsListOptedInTypesResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(NotificationsListOptedInTypesResponsePydantic, raw_response.body)
    ...
    def list_opted_in_types(
        ...
        raw_response = self.raw.list_opted_in_types(
            customer_id=customer_id,
            x_request_id=x_request_id,
        )
        if validate:
