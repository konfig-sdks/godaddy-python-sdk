...
class BaseApi(api_client.Api):
    ...
    def _opt_in_notifications_mapped_args(
        self,
        customer_id: str,
    ...
    async def _aopt_in_notifications_oapg(
        self,
    ...
    def _opt_in_notifications_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class OptInNotificationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aopt_in_notifications(
        self,
        customer_id: str,
        types: typing.List[str],
        x_request_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._opt_in_notifications_mapped_args(
            customer_id=customer_id,
            types=types,
            x_request_id=x_request_id,
        )
        return await self._aopt_in_notifications_oapg(
    ...
    def opt_in_notifications(
        ...
        return self._opt_in_notifications_oapg(
            query_params=args.query,
            header_params=args.header,
            path_params=args.path,
        )

class OptInNotifications(BaseApi):
    ...
    async def aopt_in_notifications(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aopt_in_notifications(
            customer_id=customer_id,
            types=types,
            x_request_id=x_request_id,
            **kwargs,
    ...
    def opt_in_notifications(
        ...
        raw_response = self.raw.opt_in_notifications(
            customer_id=customer_id,
            types=types,
            x_request_id=x_request_id,
        )
