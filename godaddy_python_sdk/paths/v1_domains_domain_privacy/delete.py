...
class BaseApi(api_client.Api):
    ...
    def _cancel_privacy_request_mapped_args(
        self,
        domain: str,
    ...
    async def _acancel_privacy_request_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/domains/{domain}/privacy',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _cancel_privacy_request_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CancelPrivacyRequestRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_privacy_request(
        self,
        domain: str,
        x_shopper_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._cancel_privacy_request_mapped_args(
            domain=domain,
            x_shopper_id=x_shopper_id,
        )
        return await self._acancel_privacy_request_oapg(
    ...
    def cancel_privacy_request(
        ...
        return self._cancel_privacy_request_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class CancelPrivacyRequest(BaseApi):
    ...
    async def acancel_privacy_request(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_privacy_request(
            domain=domain,
            x_shopper_id=x_shopper_id,
            **kwargs,
        )
    ...
    def cancel_privacy_request(
        ...
        raw_response = self.raw.cancel_privacy_request(
            domain=domain,
            x_shopper_id=x_shopper_id,
        )
