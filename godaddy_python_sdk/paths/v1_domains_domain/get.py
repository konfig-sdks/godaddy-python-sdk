...
from godaddy_python_sdk.model.domain_detail import DomainDetail as DomainDetailSchema
...
from godaddy_python_sdk.type.domain_detail import DomainDetail
...
from godaddy_python_sdk.pydantic.domain_detail import DomainDetail as DomainDetailPydantic
...
SchemaFor200ResponseBodyApplicationJson = DomainDetailSchema
SchemaFor200ResponseBodyApplicationJavascript = DomainDetailSchema
SchemaFor200ResponseBodyApplicationXml = DomainDetailSchema
SchemaFor200ResponseBodyTextJavascript = DomainDetailSchema
SchemaFor200ResponseBodyTextXml = DomainDetailSchema
...
SchemaFor203ResponseBodyApplicationJson = DomainDetailSchema
SchemaFor203ResponseBodyApplicationJavascript = DomainDetailSchema
SchemaFor203ResponseBodyApplicationXml = DomainDetailSchema
SchemaFor203ResponseBodyTextJavascript = DomainDetailSchema
SchemaFor203ResponseBodyTextXml = DomainDetailSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_domain_details_mapped_args(
        self,
        domain: str,
    ...
    async def _aget_domain_details_oapg(
        self,
...
class GetDomainDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_domain_details(
        self,
        domain: str,
        x_shopper_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_domain_details_mapped_args(
            domain=domain,
            x_shopper_id=x_shopper_id,
        )
        return await self._aget_domain_details_oapg(
    ...
    def get_domain_details(
        ...
        return self._get_domain_details_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetDomainDetails(BaseApi):
    ...
    async def aget_domain_details(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DomainDetailPydantic:
        raw_response = await self.raw.aget_domain_details(
            domain=domain,
            x_shopper_id=x_shopper_id,
            **kwargs,
        )
        if validate:
            return DomainDetailPydantic(**raw_response.body)
        return api_client.construct_model_instance(DomainDetailPydantic, raw_response.body)
    ...
    def get_domain_details(
        ...
        raw_response = self.raw.get_domain_details(
            domain=domain,
            x_shopper_id=x_shopper_id,
        )
        if validate:
