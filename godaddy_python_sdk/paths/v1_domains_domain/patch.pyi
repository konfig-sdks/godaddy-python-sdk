...
from godaddy_python_sdk.model.consent_domain_update import ConsentDomainUpdate as ConsentDomainUpdateSchema
from godaddy_python_sdk.model.error_limit import ErrorLimit as ErrorLimitSchema
from godaddy_python_sdk.model.domain_update import DomainUpdate as DomainUpdateSchema

from godaddy_python_sdk.type.domain_update import DomainUpdate
...
from godaddy_python_sdk.pydantic.domain_update import DomainUpdate as DomainUpdatePydantic
from godaddy_python_sdk.pydantic.consent_domain_update import ConsentDomainUpdate as ConsentDomainUpdatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = DomainUpdateSchema
SchemaForRequestBodyApplicationXml = DomainUpdateSchema
SchemaForRequestBodyTextXml = DomainUpdateSchema


request_body_domain_update = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_domain_details_mapped_args(
        self,
        domain: str,
        consent: typing.Optional[ConsentDomainUpdate] = None,
        expose_whois: typing.Optional[bool] = None,
        locked: typing.Optional[bool] = None,
        name_servers: typing.Optional[typing.List[typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        if expose_whois is not None:
            _body["exposeWhois"] = expose_whois
        ...
        if subaccount_id is not None:
            _body["subaccountId"] = subaccount_id
        args.body = _body
    ...
    async def _aupdate_domain_details_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_domain_update.serialize(body, content_type)
    ...
    def _update_domain_details_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class UpdateDomainDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_domain_details(
        self,
        domain: str,
        consent: typing.Optional[ConsentDomainUpdate] = None,
        expose_whois: typing.Optional[bool] = None,
        ...
        **kwargs,
        ...
        args = self._update_domain_details_mapped_args(
            body=body,
            domain=domain,
            consent=consent,
        ...
        return await self._aupdate_domain_details_oapg(
            body=args.body,
    ...
    def update_domain_details(
        ...
        return self._update_domain_details_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class UpdateDomainDetails(BaseApi):
    ...
    async def aupdate_domain_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_domain_details(
            body=body,
            domain=domain,
            consent=consent,
            expose_whois=expose_whois,
    ...
    def update_domain_details(
        ...
        raw_response = self.raw.update_domain_details(
            body=body,
            domain=domain,
            consent=consent,
            expose_whois=expose_whois,
