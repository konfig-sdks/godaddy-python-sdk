...
class BaseApi(api_client.Api):
    ...
    def _restart_transfer_in_mapped_args(
        self,
        customer_id: str,
        domain: str,
    ...
    async def _arestart_transfer_in_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v2/customers/{customerId}/domains/{domain}/transferInRestart',
            auth_settings=_auth,
            headers=_headers,
        )
...
class RestartTransferInRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arestart_transfer_in(
        self,
        customer_id: str,
        domain: str,
        x_request_id: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._restart_transfer_in_mapped_args(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
        return await self._arestart_transfer_in_oapg(
    ...
    def restart_transfer_in(
        ...
        return self._restart_transfer_in_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RestartTransferIn(BaseApi):
    ...
    async def arestart_transfer_in(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arestart_transfer_in(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
            **kwargs,
    ...
    def restart_transfer_in(
        ...
        raw_response = self.raw.restart_transfer_in(
            customer_id=customer_id,
            domain=domain,
            x_request_id=x_request_id,
        )
