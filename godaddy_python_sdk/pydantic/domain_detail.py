...
from godaddy_python_sdk.pydantic.verifications_domain import VerificationsDomain

class DomainDetail(BaseModel):
    # Authorization code for transferring the Domain
    auth_code: str = Field(alias='authCode')

    contact_admin: Contact = Field(alias='contactAdmin')

    contact_billing: Contact = Field(alias='contactBilling')

    contact_registrant: Contact = Field(alias='contactRegistrant')

    contact_tech: Contact = Field(alias='contactTech')
    ...
    verifications: typing.Optional[VerificationsDomain] = Field(None, alias='verifications')
