...
from godaddy_python_sdk.pydantic.maintenance_system import MaintenanceSystem
...
class MaintenanceDetail(BaseModel):
    ...
    systems: typing.Optional[typing.List[MaintenanceSystem]] = Field(None, alias='systems')
