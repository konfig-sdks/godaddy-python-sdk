...
from godaddy_python_sdk.exceptions_base import ApiValueError
from godaddy_python_sdk.exceptions import ClientConfigurationError
from godaddy_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = godaddy_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "http://api.ote-godaddy.com" if host is None else host
        """Default Base url
        """
        ...
        if api_secret:
            self.api_key['apiSecret'] = api_secret
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("godaddy_python_sdk")
