...
class JsonSchema(
        ...
        class properties:
            ...
            class models(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonSchema']:
                        return JsonSchema
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['JsonSchema'], typing.List['JsonSchema']],
                ...
                def __getitem__(self, i: int) -> 'JsonSchema':
            ...
            class properties(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['JsonProperty']:
                        return JsonProperty
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['JsonProperty'], typing.List['JsonProperty']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'properties':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'JsonProperty':
                    return super().__getitem__(i)
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "models", "properties", "required", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "models", "properties", "required", ], str]):
