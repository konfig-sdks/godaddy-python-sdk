...
class DNSRecord(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "name", "type", "port", "priority", "protocol", "service", "ttl", "weight", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "name", "type", "port", "priority", "protocol", "service", "ttl", "weight", ], str]):
