...
class DNSRecordCreateTypeName(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["data", "port", "priority", "protocol", "service", "ttl", "weight", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["data", "port", "priority", "protocol", "service", "ttl", "weight", ], str]):
