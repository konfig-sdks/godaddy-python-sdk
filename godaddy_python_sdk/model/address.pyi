...
class Address(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["address1", "city", "country", "postalCode", "state", "address2", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["address1", "city", "country", "postalCode", "state", "address2", ], str]):
