...
class ErrorLimit(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            retryAfterSec = schemas.IntSchema
    ...
    retryAfterSec: MetaOapg.properties.retryAfterSec
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["code"]) -> MetaOapg.properties.code: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["retryAfterSec"]) -> MetaOapg.properties.retryAfterSec: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "retryAfterSec", "fields", "message", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["retryAfterSec"]) -> MetaOapg.properties.retryAfterSec: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "retryAfterSec", "fields", "message", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        retryAfterSec: typing.Union[MetaOapg.properties.retryAfterSec, decimal.Decimal, int, ],
