...
class MaintenanceDetail(
        ...
        class properties:
            ...
            class systems(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MaintenanceSystem']:
                        return MaintenanceSystem
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['MaintenanceSystem'], typing.List['MaintenanceSystem']],
                ...
                def __getitem__(self, i: int) -> 'MaintenanceSystem':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["maintenanceId"], typing_extensions.Literal["summary"], typing_extensions.Literal["createdAt"], typing_extensions.Literal["reason"], typing_extensions.Literal["environment"], typing_extensions.Literal["modifiedAt"], typing_extensions.Literal["startsAt"], typing_extensions.Literal["type"], typing_extensions.Literal["endsAt"], typing_extensions.Literal["status"], typing_extensions.Literal["systems"], typing_extensions.Literal["tlds"], ]):
