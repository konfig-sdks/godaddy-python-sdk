...
from godaddy_python_sdk.type.maintenance_system import MaintenanceSystem

class RequiredMaintenanceDetail(TypedDict):
...
class OptionalMaintenanceDetail(TypedDict, total=False):
    # List of systems that are impacted by the maintenance.
    systems: typing.List[MaintenanceSystem]

    # List of tlds that are in maintenance.  Generally only applies when `type` is REGISTRY
    tlds: typing.List[str]

class MaintenanceDetail(RequiredMaintenanceDetail, OptionalMaintenanceDetail):
    pass
