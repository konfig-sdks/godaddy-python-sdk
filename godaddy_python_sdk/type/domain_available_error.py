...
class RequiredDomainAvailableError(TypedDict):
...
class OptionalDomainAvailableError(TypedDict, total=False):
    # Human-readable, English description of the error
    message: str

class DomainAvailableError(RequiredDomainAvailableError, OptionalDomainAvailableError):
    pass
