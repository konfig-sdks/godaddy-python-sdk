...
class RequiredDomainForwarding(TypedDict):
...
class OptionalDomainForwarding(TypedDict, total=False):
    mask: DomainForwardingMask

class DomainForwarding(RequiredDomainForwarding, OptionalDomainForwarding):
    pass
